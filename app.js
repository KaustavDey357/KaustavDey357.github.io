    ...
    h('div', { className: 'wrap hero-inner' },
      ...
      h('div', { className: 'hero-main' },
        ...
        h('div', { className: 'cta rise' },
          h(Magnetic, null, h('a', { className: 'btn btn-primary', href: EMAIL }, h(Icon, { d: ICONS.mail }), 'Email me')),
          h(Magnetic, null, h('a', { className: 'btn btn-ghost', href: GITHUB, target: '_blank', rel: 'noopener noreferrer' }, h(Icon, { d: ICONS.git }), 'GitHub'))),
        h(Pipeline))),
    h(Reveal));
}
  ...
  return h('section', { className: 'block lead-block wrap', 'aria-labelledby': 'lx' },
    h(Rise, { threshold: 0.1 },
      h(Spot, { className: 'feature', id: 'leadsexpo' },
        ...
        h(RiseGroup, { as: 'div', className: 'feature-points', threshold: 0.1 },
          [
...
function Services() {
  return h('section', { className: 'block wrap', id: 'services' },
    h(Rise, null, h('h2', null, 'What I do'), h('p', { className: 'section-lead' }, 'I help solo developers and early-stage startups deploy apps to AWS using DevOps best practices.')),
    h(RiseGroup, { as: 'div', className: 'services' },
...
function Work() {
  return h('section', { className: 'block wrap', id: 'work' },
    h(Rise, null, h('h2', null, 'Projects')),
    h(RiseGroup, { as: 'div', className: 'projects' },
...
function Writing() {
  ...
  return h('section', { className: 'block wrap', id: 'writing' },
    h(Rise, null, h('h2', null, 'Writing')),
    h(RiseGroup, { as: 'div', className: 'posts' },
...
function Contact() {
  ...
  return h('section', { className: 'block wrap contact', id: 'contact' },
    h(Rise, null,
      ...
      h(Magnetic, null, h('a', { className: 'btn btn-primary btn-lg', href: EMAIL }, h(Icon, { d: ICONS.mail }), 'deykaustav357@gmail.com')),
